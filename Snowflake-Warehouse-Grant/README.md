...
1. Write the JSON schema describing your resource, [snowflake-warehouse-grant.json](./snowflake-warehouse-grant.json)
2. Implement your resource handlers in [handlers.ts](./snowflake-warehouse-grant/handlers.ts)

> Don't modify [models.ts](./snowflake-warehouse-grant/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
