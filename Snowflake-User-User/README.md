...
1. Write the JSON schema describing your resource, [snowflake-user-user.json](./snowflake-user-user.json)
2. Implement your resource handlers in [handlers.ts](./snowflake-user-user/handlers.ts)

> Don't modify [models.ts](./snowflake-user-user/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
