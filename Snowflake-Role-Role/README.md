...
1. Write the JSON schema describing your resource, [snowflake-role-role.json](./snowflake-role-role.json)
2. Implement your resource handlers in [handlers.ts](./snowflake-role-role/handlers.ts)

> Don't modify [models.ts](./snowflake-role-role/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
